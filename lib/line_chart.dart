...
class LineCharts extends CustomPainter {
  List<double> points;
  double lineWidth;
  double pointSize;
  Color lineColor;
  ...
  LineCharts({required this.points, required this.pointSize, required this.lineWidth, required this.lineColor, required this.pointColor});
  ...
  @override
  bool shouldRepaint(LineCharts oldDelegate) {
